...
class PaymentUpdateRequest(object):
    ...
    def __init__(
        ...
        """PaymentUpdateRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def request(self):
        """Gets the request of this PaymentUpdateRequest.  # noqa: E501

        Request  # noqa: E501

        :return: The request of this PaymentUpdateRequest.  # noqa: E501
        :rtype: Request
        """
    ...
    def request(self, request):
        """Sets the request of this PaymentUpdateRequest.

        Request  # noqa: E501

        :param request: The request of this PaymentUpdateRequest.  # noqa: E501
        :type: Request
        """
        if request is None:
            raise ValueError(
    ...
    @property
    def operation(self):
        """Gets the operation of this PaymentUpdateRequest.  # noqa: E501

        `CHANGE_STATUS` value  # noqa: E501

        :return: The operation of this PaymentUpdateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def operation(self, operation):
        """Sets the operation of this PaymentUpdateRequest.

        `CHANGE_STATUS` value  # noqa: E501

        :param operation: The operation of this PaymentUpdateRequest.  # noqa: E501
        :type: str
        """
    ...
    def transaction_data(self):
        """Gets the transaction_data of this PaymentUpdateRequest.  # noqa: E501


        :return: The transaction_data of this PaymentUpdateRequest.  # noqa: E501
        :rtype: PaymentUpdateTransactionData
        """
    ...
    def transaction_data(self, transaction_data):
        """Sets the transaction_data of this PaymentUpdateRequest.


        :param transaction_data: The transaction_data of this PaymentUpdateRequest.  # noqa: E501
        :type: PaymentUpdateTransactionData
        """
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if value is not None:
                    result[attr] = value
        if issubclass(PaymentUpdateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaymentUpdateRequest):
            return False
