...
class RecurringUpdateRequest(object):
    ...
    @property
    def request(self):
        """Gets the request of this RecurringUpdateRequest.  # noqa: E501

        Request  # noqa: E501

        :return: The request of this RecurringUpdateRequest.  # noqa: E501
        :rtype: Request
        """
    ...
    def request(self, request):
        """Sets the request of this RecurringUpdateRequest.

        Request  # noqa: E501

        :param request: The request of this RecurringUpdateRequest.  # noqa: E501
        :type: Request
        """
        if request is None:
            raise ValueError(
    ...
    @property
    def operation(self):
        """Gets the operation of this RecurringUpdateRequest.  # noqa: E501

        `CHANGE_STATUS` value  # noqa: E501

        :return: The operation of this RecurringUpdateRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def operation(self, operation):
        """Sets the operation of this RecurringUpdateRequest.

        `CHANGE_STATUS` value  # noqa: E501

        :param operation: The operation of this RecurringUpdateRequest.  # noqa: E501
        :type: str
        """
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if value is not None:
                    result[attr] = value
        if issubclass(RecurringUpdateRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecurringUpdateRequest):
            return False
