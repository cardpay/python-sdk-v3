...
class PayoutResponseEWalletAccount(object):
    ...
    def __init__(self, id=None):  # noqa: E501
        """PayoutResponseEWalletAccount - a model defined in Swagger"""  # noqa: E501
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if value is not None:
                    result[attr] = value
        if issubclass(PayoutResponseEWalletAccount, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PayoutResponseEWalletAccount):
            return False
