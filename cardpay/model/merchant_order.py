...
class MerchantOrder(object):
    ...
    """
    swagger_types = {"id": "str", "items": "list[Item]"}

    attribute_map = {"id": "id", "items": "items"}

    def __init__(self, id=None, items=None):  # noqa: E501
        """MerchantOrder - a model defined in Swagger"""  # noqa: E501
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if value is not None:
                    result[attr] = value
        if issubclass(MerchantOrder, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MerchantOrder):
            return False
