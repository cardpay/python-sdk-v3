...
class RecurringFilterParameters(object):
    ...
    @property
    def request_id(self):
        """Gets the request_id of this RecurringFilterParameters.  # noqa: E501

        Request ID  # noqa: E501

        :return: The request_id of this RecurringFilterParameters.  # noqa: E501
        :rtype: str
        """
    ...
    def request_id(self, request_id):
        """Sets the request_id of this RecurringFilterParameters.

        Request ID  # noqa: E501

        :param request_id: The request_id of this RecurringFilterParameters.  # noqa: E501
        :type: str
        """
    ...
    def merchant_order_id(self):
        """Gets the merchant_order_id of this RecurringFilterParameters.  # noqa: E501

        Merchant order number from the merchant system  # noqa: E501

        :return: The merchant_order_id of this RecurringFilterParameters.  # noqa: E501
        :rtype: str
        """
    ...
    def merchant_order_id(self, merchant_order_id):
        """Sets the merchant_order_id of this RecurringFilterParameters.

        Merchant order number from the merchant system  # noqa: E501

        :param merchant_order_id: The merchant_order_id of this RecurringFilterParameters.  # noqa: E501
        :type: str
        """
    ...
    def payment_method(self):
        """Gets the payment_method of this RecurringFilterParameters.  # noqa: E501

        Used payment method type name from payment methods list  # noqa: E501

        :return: The payment_method of this RecurringFilterParameters.  # noqa: E501
        :rtype: str
        """
    ...
    def payment_method(self, payment_method):
        """Sets the payment_method of this RecurringFilterParameters.
    ...
    @property
    def start_time(self):
        """Gets the start_time of this RecurringFilterParameters.  # noqa: E501
        ...
        :return: The start_time of this RecurringFilterParameters.  # noqa: E501
        :rtype: datetime
        """
    ...
    def start_time(self, start_time):
        """Sets the start_time of this RecurringFilterParameters.

        Date and time up to milliseconds (in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format) when requested period starts (inclusive), UTC time, default is 24 hours before 'end_time' (format: yyyy-MM-dd'T'HH:mm:ss'Z')  # noqa: E501

        :param start_time: The start_time of this RecurringFilterParameters.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def end_time(self):
        """Gets the end_time of this RecurringFilterParameters.  # noqa: E501
        ...
        :return: The end_time of this RecurringFilterParameters.  # noqa: E501
        :rtype: datetime
        """
    ...
    def end_time(self, end_time):
        """Sets the end_time of this RecurringFilterParameters.

        Date and time up to milliseconds (in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format) when requested period ends (not inclusive), UTC time, must be less than 7 days after 'start_time', default is current time (format: yyyy-MM-dd'T'HH:mm:ss'Z')  # noqa: E501

        :param end_time: The end_time of this RecurringFilterParameters.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def sort_order(self):
        """Gets the sort_order of this RecurringFilterParameters.  # noqa: E501

        Sort based on order of results. `asc` for ascending order or `desc` for descending order (default value)  # noqa: E501

        :return: The sort_order of this RecurringFilterParameters.  # noqa: E501
        :rtype: str
        """
    ...
    def sort_order(self, sort_order):
        """Sets the sort_order of this RecurringFilterParameters.

        Sort based on order of results. `asc` for ascending order or `desc` for descending order (default value)  # noqa: E501

        :param sort_order: The sort_order of this RecurringFilterParameters.  # noqa: E501
        :type: str
        """
    ...
    @property
    def currency(self):
        """Gets the currency of this RecurringFilterParameters.  # noqa: E501

        [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) currency code of transactions currency  # noqa: E501

        :return: The currency of this RecurringFilterParameters.  # noqa: E501
        :rtype: str
        """
    ...
    def currency(self, currency):
        """Sets the currency of this RecurringFilterParameters.

        [ISO 4217](https://en.wikipedia.org/wiki/ISO_4217) currency code of transactions currency  # noqa: E501

        :param currency: The currency of this RecurringFilterParameters.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this RecurringFilterParameters.  # noqa: E501

        Filter recurring payments by certain type (applicable to /api/recurrings endpoint only): `SCHEDULED` for scheduled recurring payments `ONECLICK` for one-click payments `INSTALLMENT` for installment payments  # noqa: E501

        :return: The type of this RecurringFilterParameters.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this RecurringFilterParameters.

        Filter recurring payments by certain type (applicable to /api/recurrings endpoint only): `SCHEDULED` for scheduled recurring payments `ONECLICK` for one-click payments `INSTALLMENT` for installment payments  # noqa: E501

        :param type: The type of this RecurringFilterParameters.  # noqa: E501
        :type: str
        """
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if value is not None:
                    result[attr] = value
        if issubclass(RecurringFilterParameters, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecurringFilterParameters):
            return False
