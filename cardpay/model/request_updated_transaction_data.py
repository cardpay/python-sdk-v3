...
class RequestUpdatedTransactionData(object):
    ...
    """
    swagger_types = {"status_to": "str"}

    attribute_map = {"status_to": "status_to"}

    def __init__(self, status_to=None):  # noqa: E501
        """RequestUpdatedTransactionData - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def status_to(self):
        """Gets the status_to of this RequestUpdatedTransactionData.  # noqa: E501

        Payment, one-click recurring: `COMPLETE` or `REVERSE` status to be set. Refund, payout: `REVERSE` status to be set.  # noqa: E501

        :return: The status_to of this RequestUpdatedTransactionData.  # noqa: E501
        :rtype: str
        """
    ...
    def status_to(self, status_to):
        """Sets the status_to of this RequestUpdatedTransactionData.
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if value is not None:
                    result[attr] = value
        if issubclass(RequestUpdatedTransactionData, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RequestUpdatedTransactionData):
            return False
