...
class PixAccountDetailsApi(object):
    ...
    def banks(self, currency, method, **kwargs):  # noqa: E501
        """Get adapter banks list  # noqa: E501
        ...
        (data) = self.banks_with_http_info(currency, method, **kwargs)  # noqa: E501
        return data

    def banks_with_http_info(self, currency, method, **kwargs):  # noqa: E501
        """Get adapter banks list  # noqa: E501
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'" " to method banks" % key
                )
            params[key] = val
        del params["kwargs"]
