...
class PayoutUpdateResponse(object):
    ...
    swagger_types = {
        ...
        "payout_data": "ResponseUpdatedTransactionData",
    }

    attribute_map = {"merchant_order": "merchant_order", "payout_data": "payout_data"}

    def __init__(self, merchant_order=None, payout_data=None):  # noqa: E501
        """PayoutUpdateResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def merchant_order(self):
        """Gets the merchant_order of this PayoutUpdateResponse.  # noqa: E501

        Merchant order data  # noqa: E501

        :return: The merchant_order of this PayoutUpdateResponse.  # noqa: E501
    ...
    def merchant_order(self, merchant_order):
        """Sets the merchant_order of this PayoutUpdateResponse.

        Merchant order data  # noqa: E501

        :param merchant_order: The merchant_order of this PayoutUpdateResponse.  # noqa: E501
    ...
    def payout_data(self):
        """Gets the payout_data of this PayoutUpdateResponse.  # noqa: E501

        Transaction data  # noqa: E501

        :return: The payout_data of this PayoutUpdateResponse.  # noqa: E501
    ...
    def payout_data(self, payout_data):
        """Sets the payout_data of this PayoutUpdateResponse.

        Transaction data  # noqa: E501

        :param payout_data: The payout_data of this PayoutUpdateResponse.  # noqa: E501
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                if value is not None:
                    result[attr] = value
        if issubclass(PayoutUpdateResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PayoutUpdateResponse):
            return False
