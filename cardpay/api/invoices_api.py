...
class InvoicesApi(object):
    ...
    def create_invoice(self, invoice_request, **kwargs):  # noqa: E501
        """Create invoice  # noqa: E501

        Endpoint for invoice creation  # noqa: E501
        ...
        (data) = self.create_invoice_with_http_info(
            invoice_request, **kwargs
        )  # noqa: E501
        return data

    def create_invoice_with_http_info(self, invoice_request, **kwargs):  # noqa: E501
        """Create invoice  # noqa: E501
        ...
        if "invoice_request" not in params or params["invoice_request"] is None:
            raise ValueError(
                "Missing the required parameter `invoice_request` when calling `create_invoice`"
            )  # noqa: E501
    ...
    def get_invoice(self, invoice_id, **kwargs):  # noqa: E501
        """Get invoice information  # noqa: E501

        Method allows to get information about single invoice.  # noqa: E501
        :param str invoice_id: Invoice ID (required)
    ...
    def get_invoice_with_http_info(self, invoice_id, **kwargs):  # noqa: E501
        ...
        if "invoice_id" not in params or params["invoice_id"] is None:
            raise ValueError(
                "Missing the required parameter `invoice_id` when calling `get_invoice`"
            )  # noqa: E501
